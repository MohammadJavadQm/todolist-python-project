...
Handles user input and orchestrates calls to the service layer.
"""
...
class CLI:
    ...
    def create_project(self):
        ...
        try:
            ...
            project = self._service.create_project(name, desc)
    ...
    def edit_project(self):
        ...
        try:
            ...
            project = self._service.edit_project(project_id, new_name, new_desc)
    ...
    def add_task(self):
        ...
        try:
            ...
            task = self._service.add_task_to_project(project_id, title, description, deadline or None)
    ...
    def list_tasks(self):
        ...
        try:
            ...
            tasks = self._service.get_tasks_for_project(project_id)
            if not tasks:
    ...
    def edit_task(self):
        ...
        try:
            ...
            task = self._service.edit_task(project_id, task_id, new_title, new_desc, new_deadline)
